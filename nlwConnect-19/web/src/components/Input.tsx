...
//DAQUI PARA BAIXA O DIEGO DIVIDIU O COMPONENTE ACIMA EM 3 COMPONENTES.
...
interface InputIFieldProps extends ComponentProps<"input"> {}

export function InputField(props: InputIFieldProps) {
